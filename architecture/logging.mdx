...
description: "BotMeriendo logs to bot.log and stdout via Python's logging module, with per-namespace overrides that suppress discord.py noise and surface gateway events."
---
