...
sidebarTitle: "Events"
description: "BotMeriendo's events cog has four gateway listeners: bot lifecycle, welcome DMs, command error replies, and auto voice-channel disconnect on inactivity."
---
