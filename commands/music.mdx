---
title: "Music commands for BotMeriendo"
sidebarTitle: "Music"
...
If BotMeriendo is the **only member** remaining in a voice channel, it waits **60 seconds** and then disconnects automatically, clearing the guild's queue. This frees up voice resources when everyone has left.

<Note>
  The auto-disconnect timer resets if another member rejoins the channel within the 60-second window.
</Note>
